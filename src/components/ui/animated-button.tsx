...
const buttonVariants = cva(
  "group relative z-0 bg-white dark:bg-[rgba(0,0,0,1)] flex cursor-pointer items-center justify-center overflow-hidden whitespace-nowrap  transform-gpu transition-all duration-300 ease-in-out active:translate-y-px",
  {
    variants: {
      variant: {
        default: "text-blue-400 border border-blue-400/20 hover:text-blue-300",
        outline:
          "bg-transparent text-blue-400 border border-blue-400 hover:text-blue-300",
        ghost: "bg-transparent text-blue-400 hover:bg-blue-950/30",
        glow: "text-blue-400 border border-blue-400/30 hover:text-blue-300 hover:shadow-glow",
      },
      size: {
      ...
      glow: {
        true: "hover:shadow-[0_0_5px_#3B82F6,0_0_25px_#3B82F6]",
        false: "",
      },
      textEffect: {
  ...
  (
    {
      ...
      shimmerColor = "#3B82F6", // Mudando para azul
      shimmerSize = "0.05em",
      shimmerDuration = "3s",
      borderRadius = "100px",
